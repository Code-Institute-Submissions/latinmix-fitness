...
![Website navigation bar](https://github.com/belaventer/latinmix-fitness/blob/master/screenshots/navigation-screenshot.png "Website navigation bar")
    ...
    - As a new visitor, without the use of the Navigation Bar, I can also complete the following paths from Home page to contacting the business:
        Home > Class > Contact
        Home > Plans > Contact
    - As a new visitor, I can clearly identify which page I'm on from the Heading on top of the page and the Hero Image for the Home page.
...
![Business details on Contact page](https://github.com/belaventer/latinmix-fitness/blob/master/screenshots/businessdetails-screenshot.png "Business details on Contact page")
    ...
    - As a potential client, I can find the Business address as well as an interactive embedded Google maps on the bottom of the Home page.
...
![Plans page layout](https://github.com/belaventer/latinmix-fitness/blob/master/screenshots/plans-screenshot.png "Plans page layout")
    ...
    - As a potential client, I can learn more about each plan option by clicking the button "Find you perfect plan!" on the Home page.
...
Home page had a decreased Performance Audit due to large content (images). Point for improvement on future versions of website.
...
1. **Navigation Bar** feature **Header Logo**:
   ...
   | 1.3 | Repeat steps 1 and 2 for all other pages and verify the same results are achieved. | Pass |
...
2. **Navigation Bar** feature **Navigation Links**:
   ...
   | 2.10 | From the Home page, use the developer tool to decrease the view width. Verify links collapse to a **Burger button** on the top right corner of the page. | Pass |
   | 2.11 | From the previous step, click on the burger button and verify the links are shown. | Pass |
   | 2.12 | Repeat steps 1 to 11 for all other pages and verify the same results are achieved. | Fail - Navbar on other pages did not have the same style as Home page as link to style.css was not initially included on other html files - **Issue fixed** |
...
3. **Footer** feature **Responsiveness**:
   ...
   | 3.3 | From the Home page, use the developer tool to decrease the view width. Verify the footer content does not break and it stacks as the screen gets narrower. | Fail - the use of Bootstrap alone was not enough to fit the content, as the font size also need to be reduced. Media queries added for this purpose - **Issue fixed** |
   | 3.4 | Repeat steps 1 to 3 for all other pages and verify the same results are achieved. | Pass |
...
4. **Footer** feature **Social Media**:
   ...
   | 4.3 | Repeat steps 1 and 2 for all other pages and verify the same results are achieved. | Pass |
...
6. **Classes - Home page** feature:
   ...
   | 6.4 | From the Home page, use the developer tool to decrease the view width. Verify the images decrease to 2 by side and then stack 1 on top of each other. | Fail - the use of max/min-width was overwritten Bootstraps column responsiveness. Div to force break added for small to large sizes - **Issue fixed**  |
   | 6.5 | From the Home page, use the developer tool to decrease the view width below 1200px. Verify the image text is always visible. | Fail - as border were always visible on smaller screens, for small displays with hover function a second border appeared on hover. Hover border style removed with media query. - **Issue fixed**  |
...
7. **Plans - Home page** feature:
   ...
   | 7.2 | From the Home page, verify the price background and colour is blinking  on the section heading. | Pass |
   | 7.3 | From the Home page, click the **Find your plan** button and verify the **Plans** page opens. | Pass |
   | 7.4 | From the Home page, use the developer tool to decrease the view width. Verify the sections content do not break. | Pass |
...
8. **Gallery - Home page** feature:
   ...
   | 8.4 | From the Home page, use the developer tool to decrease the view width. Verify the images stack in 2, then 3 and 5 rows. | Pass |
...
9. **Contact - Home and Contact page** feature:
   ...
   | 9.3 | From the Home page, use the developer tool to decrease the view width. Verify the sections content do not break. | Pass |
...
10. **Forms - Contact page** feature:
   ...
   | 10.2 | Click on the first form button without filling any of the fields. Verify the form is not sent and default tooltip is shown. | Pass |
   ...
   | 10.6 | Click on the Selection field and verify four different options are available. Choose one option and click the button. Verify the form is not sent and default tooltip is shown.| Pass |
   ...
   | 10.10 | From the Contact page, use the developer tool to decrease the view width. Verify the sections content do not break. | Pass |
...
11. **Plans - Plans page** feature:
   ...
   | 11.3 | Return to the **Plans** page, use the developer tool to decrease the view width. Verify the sections content do not break. | Pass |
...
12. **Video - Classes page** feature:
   ...
   | 12.3 | Return to the **Salsa Class** page, use the developer tool to decrease the view width. Verify the sections content do not break. | Pass |
